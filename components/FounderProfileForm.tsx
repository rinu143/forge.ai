    ...
    <div className="bg-gray-50 dark:bg-[#1a1a1a]/80 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-xl p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <div>
          ...
          <Input type="number" name="experience_years" id="experience_years" value={profile.experience_years || ''} onChange={handleChange} disabled={disabled} min="0" placeholder="e.g., 2" />
        </div>
        <div>
          <Label htmlFor="team_size">Team Size</Label>
          <Input type="number" name="team_size" id="team_size" value={profile.team_size || ''} onChange={handleChange} disabled={disabled} min="0" placeholder="e.g., 1" />
        </div>
        <div>
